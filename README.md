...
> GitHub 仓库为只读镜像，未开启 Issues、PRs、Wiki 和 Discussions。  
> 如需提交 Issue、PR 或 Star 关注，请前往 [Codeberg 主仓库](https://codeberg.org/flandre_scarlet/bsetm-dl)。
...
- **Codeberg**（主仓库，用于提交 Issue / PR / Star）：[https://codeberg.org/flandre_scarlet/bsetm-dl](https://codeberg.org/flandre_scarlet/bsetm-dl)
- **GitHub**（只读镜像）：[https://github.com/fldlqu/bsetm-dl](https://github.com/fldlqu/bsetm-dl)
